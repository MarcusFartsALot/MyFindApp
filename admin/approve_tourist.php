...
/*
|--------------------------------------------------------------------------
| Handle Approve / Reject for Tourist
|--------------------------------------------------------------------------
*/
...
/*
|--------------------------------------------------------------------------
| Load Tourists with Stats & Filters
|--------------------------------------------------------------------------
*/
$items = [];
$totalItems = 0;
...
try {
    ...
    if (is_array($tourists)) {
        foreach ($tourists as $t) {
            ...
            $t['_icon'] = '';
            $t['_photo_front'] = getFullStorageUrl($t['passport_front_url'] ?? null);
            $t['_photo_back'] = getFullStorageUrl($t['passport_back_url'] ?? null);
            $allItems[] = $t;
        }
    }
...
render_admin_start('Approve Tourists', $admin, 'dashboard');
...
<div class="tourist-page">
    ...
    <section class="tourist-header">
        <div>
            <div class="subtitle">
                <p>Review tourist registrations, then approve or reject them.</p>
                <span class="badge-tourists">🛂 Tourists</span>
            </div>
        </div>
    ...
    <div class="filter-bar">
        ...
        <div class="filter-row">
            <form method="get" style="display:flex;gap:8px;flex-wrap:wrap;align-items:center;width:100%;" id="filterForm">
                ...
                <div class="filter-group">
                    ...
                    <input type="text" name="search" class="filter-input filter-input-sm" placeholder="Profile ID, Passport..." value="<?= htmlspecialchars($searchQuery) ?>" style="min-width:160px;">
                </div>
                ...
                <div class="filter-actions">
                    ...
                    <a href="approve_tourist.php" class="btn-filter btn-filter-reset">
        ...
        <?php if ($statusFilter !== 'all' || $dateFrom !== '' || $dateTo !== '' || $searchQuery !== ''): ?>
            <div class="active-filters">
                ...
                <?php endif; ?>
                <a href="approve_tourist.php" style="font-size:11px;color:#dc3545;text-decoration:none;font-weight:500;">
            ...
            <tbody>
                <?php if (!empty($items)): ?>
                    <?php foreach ($items as $item): ?>
                        ...
                        $country = $item['passport_issuing_country'] ?? 'N/A';
                        ...
                        <tr>
                            <td>
                                <span class="type-badge type-tourist">
                                    Tourist
                                </span>
                            </td>
                    ...
                    <tr>
                        <td colspan="7" style="text-align: center; padding: 40px;">
                            <div class="empty-state">
                                ...
                                <p>No tourists found matching your criteria. Try adjusting your filters.</p>
                            </div>
                        </td>
                    </tr>
                <?php endif; ?>
...
function openDrawer(profileId) {
    ...
    if (photoFront || photoBack) {
        ...
        if (photoFront) {
            photoHtml += `<img src="${photoFront}" alt="Passport Front" onclick="openImagePreview('${photoFront}')" style="cursor:pointer;">`;
        } else {
            photoHtml += `<div class="no-photo">No Front Photo</div>`;
        }
        if (photoBack) {
            photoHtml += `<img src="${photoBack}" alt="Passport Back" onclick="openImagePreview('${photoBack}')" style="cursor:pointer;">`;
        } else {
    ...
    body.innerHTML = `
        <div class="detail-section">
            ...
            <div class="detail-value">
                <span class="type-badge type-tourist">Tourist</span>
            </div>
        </div>
        ...
        <div class="detail-section">
            <span class="detail-label">📸 Passport Photos</span>
